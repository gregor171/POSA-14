...
public class PingPongRight {
	...
	*  also possible to use thread join mechanism
	*/
	...
	*/
	     // TODO - You fill in here.
	     // or you can do 2 semaphores
	     private final SimpleSemaphore[] semaphore = new SimpleSemaphore[2];
	...
	*/
	     public PlayPingPongThread(String stringToPrint,
	    	 ...
	    	 this.semaphore[FIRST_SEMA] = semaphoreOne;
	    	 this.semaphore[SECOND_SEMA] = semaphoreTwo;
	...
	*/
	         ...
	         // TODO - You fill in here.
	    	 try{
		         for (int loopNo  = 1; loopNo  <= this.mMaxLoopIterations; ++loopNo ) {
		                acquire();
	...
	*/
	     private void acquire() {
	    	 ...
	    	 semaphore[FIRST_SEMA].acquireUninterruptibly();
	...
	*/
	 public static void process(String startString,
	     ...
	     // constructor call.
	     mLatch = new CountDownLatch(2); // MAX_NUMBER_OF_THREADS
	
	     // Create the ping and pong SimpleSemaphores that control
	     // alternation between threads.
	
	     // TODO - You fill in here, make pingSema start out unlocked.
	     SimpleSemaphore pingSema = new SimpleSemaphore(1, true); //, false);
	     // TODO - You fill in here, make pongSema start out locked.
	     SimpleSemaphore pongSema =  new SimpleSemaphore(0, true);//, false);
