...
{	
    ...
    public void begin()
    {
    	...
    	mLatch = new CountDownLatch(NUMBER_OF_THREADS); 	//NUMBER_OF_THREADS
    ...
    public void print(final String outputString)
    {
    	...
    	//mActivity.get().runOnUiThread(new Runnable(){
    		...
    		//@Override
			//public void run() {
    		//	mActivity.get()).getOutputTextView().append(outputString+"\n");
    		//	mTextViewOutput.append(outputString);
			//	mTextViewOutput.append("\n");
    		//}
    	//});
    	// OutputTextViewInterface o ;
    	
    	Activity iActivity = mActivity.get();
    	if(iActivity  == null) //0 
    		return;
